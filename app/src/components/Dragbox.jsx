...
export default function Dragbox({ id, children, component }) {
  ...
  return (
    ...
    >
      <div className="group relative flex flex-row justify-start w-min h-min px-1 py-2 border-2 border-transparent hover:border-blue-400 focus:border-blue-400 focus-within:border-blue-400 active:border-blue-400">
